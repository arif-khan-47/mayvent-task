        ...
        <div className="container m-auto h-[100%] flex">
          <div className="text-white m-auto overflow-hidden">
            ...
            <Link href={"/job"}>
              <div
                data-aos="zoom-in"
                className="mx-auto px-10 py-3 hover:scale-110 cursor-pointer hover:bg-transparent hover:border hover:border-white hover:text-white rounded-full font-bold bg-white text-black w-fit mb-10"
              >
                Find Job
              </div>
            </Link>
          ...
          <div
            data-aos="fade-down"
            className="absolute bottom-0 left-0 right-0 text-white my-3"
          >
